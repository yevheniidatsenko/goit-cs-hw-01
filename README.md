Нижче наведено оновлений приклад README.md, де спершу описано мету робіт і завдання, а потім зазначено, що є скріншоти з результатами (task_1.png для асемблерної програми та task_2.png для інтерпретатора).
